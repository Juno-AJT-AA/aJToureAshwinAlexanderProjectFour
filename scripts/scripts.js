...
totallyRadMovieQuiz.ninetiesUrl = 'https://api.themoviedb.org/3/discover/movie?api_key=bbdeeb2ee8dee00541ba5f527454ce0e&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&primary_release_date.lte=1999-12-31&primary_release_date.gte=1990-01-01';
...
totallyRadMovieQuiz.init = function() {
    ...
    $.ajax({
        url: totallyRadMovieQuiz.eightiesUrl,
        method: 'GET',
        dataType: 'JSON',
    }).then(function(object) {
        console.log(object.results[0]);
    ...
    $.ajax({
        url: totallyRadMovieQuiz.oughtsUrl,
        method: 'GET',
        dataType: 'JSON',
    }).then(function(object) {
        console.log(object.results[0]);
    ...
    $.ajax({
        url: totallyRadMovieQuiz.ninetiesUrl,
        method: 'GET',
        dataType: 'JSON',
    }).then(function(object) {
        console.log(object.results[0]);
